...
<div align="center">
  ...
  <p>
    ...
    ·
    <a href="https://github.com/WuKongOpenSource/Wukong-AICRM/blob/main/README.md#readme-chinese"><strong>中文</strong></a> | <a href="https://github.com/WuKongOpenSource/Wukong-AICRM/blob/main/README.md#readme-english"><strong>English</strong></a>
  </p>
</div>
...
| AI 对话工作台 | 客户画像与智能分析 |
| :---: | :---: |
| ![AI 对话工作台](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/03-ai-assistant-screen.png) | ![客户画像与智能分析](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/07-customer-profile-screen.png) |

| 任务管理 | AI 知识库 |
| :---: | :---: |
| ![任务管理](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/09-task-management-screen.png) | ![AI 知识库](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/17-ai-knowledge-base-screen.png) |
...
![销售跟进](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/n01-Sales%20Follow-up.png)

### 主管协同

主管可以看到哪些重点客户长时间未跟进、哪些商机存在停滞风险、哪些销售任务逾期未处理，并在关键节点安排售前、客户成功或管理者介入。

![主管协同](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/n02-Supervisor%20Collaboration.png)

### 客户成功

客户成功团队可以通过客户互动频率、服务问题、任务逾期和沟通记录提前识别风险客户，及时安排回访、升级处理或内部协同。

![客户成功](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/n03-Customer%20Success.png)

### 知识复用

系统可以将优秀销售的话术、方案、成交路径和行业经验沉淀到知识库中。新人面对客户问题时，可以通过 AI 调用企业知识生成更专业、更一致的回复。

![知识复用](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/n04-Knowledge%20Reuse.png)

## 整体架构

Wukong AICRM 以 AI Assistant 为统一交互入口，把客户管理、知识库问答和任务执行连接在同一个工作流中。

![整体架构](https://github.com/WuKongOpenSource/Wukong-AICRM/raw/main/docs/assets/feature-summary/n05-Overall%20Architecture.png)
